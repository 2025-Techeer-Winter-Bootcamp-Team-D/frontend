...
const GlassCard: React.FC<GlassCardProps> = ({
  ...
  if (variant === "light") {
    variantClasses =
      "glass-panel !shadow-none !hover:shadow-none hover:bg-white/80";
  } else if (variant === "dark") {
    variantClasses = "glass-panel-dark text-white";
  } else if (variant === "accent") {
    variantClasses =
      "bg-gradient-to-br from-shinhan-blue to-shinhan-dark text-white shadow-xl shadow-blue-500/20";
  }
